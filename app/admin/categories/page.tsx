    ...
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-bold text-primary">商品分类管理</h1>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500">
            商品新增和编辑时只能选择已启用分类。请先创建商品分类，再维护商品和规格。
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          <Button variant="deal" asChild>
            <Link href="/admin/categories/new">新增商品分类</Link>
          </Button>
          <AdminLogoutButton />
        </div>
      </div>
              ...
              <CardHeader>
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Badge variant="deal">商品 {category._count.products}</Badge>
                  </div>
                </div>
              </CardHeader>
